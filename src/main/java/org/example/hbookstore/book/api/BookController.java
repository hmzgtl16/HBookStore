...
@Tag(name = "Book Management", description = "APIs for managing books in the bookstore system.")
@RestController
...
public class BookController {
    ...
    public ResponseEntity<BookResponse> updateBook(
            @PathVariable Long id, @RequestBody UpdateBookRequest request) {
    ...
    public ResponseEntity<Page<BookResponse>> getBooksByAuthor(
            @PathVariable Long authorId, @PageableDefault(size = 20) Pageable pageable) {
    ...
    public ResponseEntity<Page<BookResponse>> getBooksByCategory(
            @PathVariable BookCategory category, @PageableDefault(size = 20) Pageable pageable) {
    ...
    public ResponseEntity<Page<BookResponse>> getBooksByFormat(
            @PathVariable BookFormat format, @PageableDefault(size = 20) Pageable pageable) {
    ...
    public ResponseEntity<Page<BookResponse>> getBooksByLanguage(
            @PathVariable String language, @PageableDefault(size = 20) Pageable pageable) {
    ...
    public ResponseEntity<Page<BookResponse>> getBooksByPublisher(
            @PathVariable String publisher, @PageableDefault(size = 20) Pageable pageable) {
